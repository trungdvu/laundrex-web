              ...
              <Popover
                panelChild={
                  <div className="flex flex-col gap-1 py-2 text-base font-bold">
                    <Link
                      href="/admin/profile"
                      className="box-bg-hover px-4 py-3 transition duration-main"
                    >
                      Profile
                    </Link>
                    <button
                      className="box-bg-hover px-4 py-3 text-left transition duration-main"
                ...
                buttonProps={{
                  className:
                    'box-bg-hover flex w-full items-center justify-between rounded-full p-3 transition duration-main',
                }}
                panelProps={{
